<template>
  <table class="">
    ...
    <tbody class="">
      <TableTr v-for="i in 10" :key="i" :isMarked="i % 2 === 0">
        <TableTd>Study Name</TableTd>
        <TableTd>Study Type</TableTd>
        <TableTd>Study Duration</TableTd>
        <TableTd>Study Location</TableTd>
        <TableTd>Study Date</TableTd>
